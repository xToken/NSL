...
local configRequestTracking = { 
								leagueConfigRequest = false, leagueConfigRetries = 0, leagueLocalConfig = "configs/nsl_leagueconfig.json", leagueExpectedVersion = 2.4, leagueConfigComplete = false,
								...
								teamConfigRequest = false, teamConfigRetries = 0, teamLocalConfig = "configs/nsl_teamconfig.json", teamExpectedVersion = 1.4, teamConfigComplete = false
								}
local NSL_Mode = "PCW"
